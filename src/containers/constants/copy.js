...
// COPY
const SIGNIN_HEADING = 'Social Analytics Sign In';
const SIGNIN_NOT_A_MEMBER = 'Not a member yet?';
...
const FLD_PLH_FNAME = 'Jane';
const FLD_LBL_FNAME = 'First Name*';
const FLD_PLH_LNAME = 'Doe';
const FLD_LBL_LNAME = 'Last Name*';
const FLD_LBL_CONFIRMATION_CODE = 'Confirmation Code*';
const FLD_PLH_CONFIRMATION_CODE = 'Enter Code';
...
const fields = {
  ...
  FLD_LBL_CONFIRMATION_CODE,
  FLD_PLH_CONFIRMATION_CODE,
};
